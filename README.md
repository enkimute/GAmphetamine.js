...
A Geometric Algebra code generator for JavaScript with advanced symbolic optimisation and a focus on performance.
...
GAmphetamine offers similar visualisation capabilities to ganja.js. This is WIP. 

# **Creating an Algebra**

GAmphetamine offers a wide ranges of options to create your algebra. Let's review a few examples. 
Mathematically, the algebras we will create are all quotient algebras of the tensor algebra with
an ideal generated by elements of the form $v \otimes v - Q(v)$, where $Q$ is an arbitrary quadratic
form, determined by it's metric signature, and $v$ is a real vector space. This is commonly written
...
the lexical ordering $e_{13}$, but allows you to specify any basis order for any type.
